  ...
  return (
    <main className="section-page">
      <section className="section-card">
        ...
        <h1>Gossip</h1>
        <p className="intro">
          Static placeholder for salon talk, city updates, family stories, soft
          venting, and the little bits of community news that travel after work.
        </p>
      ...
      <style>{`
        .section-page {
          ...
          background:
            ...
            radial-gradient(circle at 78% 14%, rgba(196, 181, 253, 0.2), transparent 28%),
