  ...
  return (
    <main className="section-page">
      <section className="section-card">
        ...
        <h1>Show Off</h1>
        <p className="intro">
          Static placeholder for nails, lashes, shop glow-ups, cafe counters,
          market shelves, before / afters, and everyday wins from the community.
        </p>
      ...
      <style>{`
        .section-page {
          ...
          background:
            ...
            radial-gradient(circle at 78% 14%, rgba(244, 114, 182, 0.18), transparent 28%),
