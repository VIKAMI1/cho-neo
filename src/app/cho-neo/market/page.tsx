  ...
  return (
    <main className="section-page">
      <section className="section-card">
        ...
        <h1>Market</h1>
        <p className="intro">
          Static placeholder for supplier leads, used chairs, nail tables, shop
          jobs, lease tips, local plugs, services, and practical small-business deals.
        </p>
      ...
      <style>{`
        .section-page {
          ...
          color: #fff7ed;
          background:
            radial-gradient(circle at 22% 18%, rgba(251, 191, 36, 0.26), transparent 30%),
            radial-gradient(circle at 78% 14%, rgba(45, 212, 191, 0.16), transparent 28%),
