  ...
  try {
    ...
    const requestDraft = (model: string) => fetch(OPENAI_ENDPOINT, {
      ...
      body: JSON.stringify({
        ...
        instructions: [
          "Bạn giúp một người trưởng thành trong cộng đồng ngành nail diễn đạt hồ sơ kết nối giữa người với người.",
          ...
          "Cùng ngành nail chỉ là điểm chung để bắt đầu; không tự biến mong muốn cá nhân thành chuyện nghề nghiệp.",
          "Giữ nguyên ý định kết bạn, đồng hành, tìm hiểu nghiêm túc hoặc cởi mở tiến xa hơn, cùng giới tính mong muốn nếu người dùng đã nói rõ.",
          "Không làm nhẹ đi và cũng không đẩy xa hơn ý định quan hệ của người dùng.",
          "Không nhắc AI, bán hàng, tuyển dụng hoặc thông tin nhận diện riêng tư.",
          "lookingFor mô tả người họ muốn gặp, điều muốn cùng chia sẻ và hướng quan hệ họ đã nói rõ.",
          "canShare mô tả sự lắng nghe, sở thích hoặc điều chân thành họ thật sự mang vào mối quan hệ.",
          "Độ dài phải tương xứng với dữ liệu: dùng đủ mọi ý liên quan, nhưng không kéo dài bằng chi tiết tự đoán.",
          "Ví dụ: 'Đi làm nhiều không có giờ tìm bạn; tìm một bạn nam; hiểu nhau và chia sẻ; nếu hợp thì tiến xa hơn; biết lắng nghe và thích du lịch với nhau' phải giữ rõ bạn nam và khả năng tiến xa hơn trong mối quan hệ, không được viết thành tiến xa hơn trong nghề.",
