...
export const choNeoRooms: ChoNeoRoom[] = [
  ...
  },
  {
    ...
    viStatus: "Đang mở",
    enStatus: "Open",
    viDescription: "Một cánh cửa nhẹ sang tiệm VIKAMI và bộ sưu tập thử nghiệm.",
    enDescription: "A gentle doorway to VIKAMI and its small pilot collection.",
    tone: "market",
