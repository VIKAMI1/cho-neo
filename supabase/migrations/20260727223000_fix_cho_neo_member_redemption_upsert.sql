-- Fix Chợ Neo Social Member redemption upsert target references.
-- PostgreSQL does not allow schema-qualified target-table references inside
-- ON CONFLICT DO UPDATE expressions; use the explicit insert target alias.
